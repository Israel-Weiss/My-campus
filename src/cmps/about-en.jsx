        ...
        <section className="screen-continer ">
            ...
            <div className="text-continer">
                ...
                <p className="txt">The control system application is a simulation of four-tower complex with forty floors.
                    <br />On each floor, you have full control of air conditioner units in each of the areas and rooms.
                </p>

                <p className="subtitle">Users</p>
                <div className="txt">the system provide with three default users:
                    <ul>
                        ...
                        <li>Operator: authorized to operate the system fully, but not to make editing changes,
                            <br />such to add or delete air conditioner units and users.
                ...
                <p className="txt">The purpose of the system is, allow the operator to control climate
                    ...
                    in every floor, in every building on the complex.
                    <br />
                    <br />Each air conditioniner unit has an operation line that show the room temperature
                    and the unit operation status.
                    In operation line, you can turn the unit on and off, set desired temperature,
                    ...
                    systems.
                    <br />
                    <br />Addition, the system warns of a significant deviation between set desired
                    ...
                    you need define on the operation line, temperature deviation and duration until an alert is raised.
                    <br />
                    <br />For example: if we set a desired temperature of 20 ℃, a temperature deviation
                    of 3 ℃, and time to alarm of 20 seconds, if the room temperature is 23 ℃
                    or more for 20 seconds, the system will raise an alarm. an allarm display will show up
                    on the operation line and new alarm will be added to the events summarie. When the temperature
                    ...
                    like a real air-conditioned areas.
                </p>
